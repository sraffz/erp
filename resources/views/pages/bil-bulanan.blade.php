                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr class="text-center">
                                            <td scope="row">JANUARI</td>
                                            <td>
                                                @foreach ($bill_bulanan_pegawai as $d)
                                                    @if ($d->bulan == '1')
                                                        {{ number_format($d->jumlah, 2, '.', ',')  }}
                                                    @endif
                                                @endforeach
                                        ...
                                        <tr class="text-center">
                                            <td scope="row">JUMLAH</td>
                                            <td>
                                                {{ number_format($jumlah_bill_pegawai, 2, '.', ',')  }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <tr class="text-center">
                                            <td scope="row">JANUARI</td>
                                            <td>
                                                @foreach ($bill_bulanan_pesara as $d)
                                                    @if ($d->bulan == '1')
                                                        {{ number_format($d->jumlah, 2, '.', ',')  }}
                                                    @endif
                                                @endforeach
                                        ...
                                        <tr class="text-center">
                                            <td scope="row">JUMLAH</td>
                                            <td>
                                                {{ number_format($jumlah_bill_pesara, 2, '.', ',')  }}
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
